...
from boa_ancient.environment import AddressType, Env, to_int
from boa_ancient.profiling import LineProfile, cache_gas_used_for_computation
from boa_ancient.util.exceptions import strip_internal_frames
from boa_ancient.util.lrudict import lrudict
from boa_ancient.vm.gas_meters import ProfilingGasMeter
from boa_ancient.vyper import _METHOD_ID_VAR
from boa_ancient.vyper.ast_utils import ast_map_of, get_fn_ancestor_from_node, reason_at
from boa_ancient.vyper.compiler_utils import (
    _compile_vyper_function,
    generate_bytecode_for_arbitrary_stmt,
    generate_bytecode_for_internal_fn,
)
from boa_ancient.vyper.decoder_utils import ByteAddressableStorage, decode_vyper_object
from boa_ancient.vyper.event import Event, RawEvent
